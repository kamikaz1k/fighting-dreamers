...
export const moveDefinitions: Record<string, MoveDefinition> = {
  jab: {
    ...
    recoveryFrames: 12,
    damage: 6,
    knockback: { base: 282, growth: 5, damageFactor: 8, angleDeg: 14 },
  ...
  forwardTilt: {
    ...
    recoveryFrames: 14,
    damage: 8,
    knockback: { base: 332, growth: 8, damageFactor: 8, angleDeg: 10 },
  ...
  upTilt: {
    ...
    recoveryFrames: 15,
    damage: 7,
    knockback: { base: 415, growth: 8, damageFactor: 8, angleDeg: 75 },
  ...
  downTilt: {
    ...
    recoveryFrames: 13,
    damage: 6,
    knockback: { base: 257, growth: 6, damageFactor: 8, angleDeg: -32 },
  ...
  forwardSmash: {
    ...
    recoveryFrames: 30,
    damage: 14,
    knockback: { base: 684, growth: 12, damageFactor: 8, angleDeg: 12 },
  ...
  upSmash: {
    ...
    recoveryFrames: 31,
    damage: 13,
    knockback: { base: 768, growth: 12, damageFactor: 8, angleDeg: 80 },
  ...
  downSmash: {
    ...
    recoveryFrames: 29,
    damage: 12,
    knockback: { base: 578, growth: 12, damageFactor: 8, angleDeg: 15 },
  ...
  neutralSpecial: {
    ...
    recoveryFrames: 18,
    damage: 9,
    knockback: { base: 382, growth: 8, damageFactor: 8, angleDeg: 14 },
  ...
  sideSpecial: {
    ...
    recoveryFrames: 20,
    damage: 11,
    knockback: { base: 485, growth: 9, damageFactor: 8, angleDeg: 12 },
  ...
  upSpecial: {
    ...
    recoveryFrames: 22,
    damage: 10,
    knockback: { base: 542, growth: 9, damageFactor: 8, angleDeg: 79 },
  ...
  downSpecial: {
    ...
    recoveryFrames: 18,
    damage: 9,
    knockback: { base: 350, growth: 7, damageFactor: 8, angleDeg: -31 },
  ...
  neutralAir: {
    ...
    recoveryFrames: 14,
    damage: 6,
    knockback: { base: 234, growth: 5, damageFactor: 8, angleDeg: 17 },
  ...
  forwardAir: {
    ...
    recoveryFrames: 16,
    damage: 7,
    knockback: { base: 313, growth: 7, damageFactor: 8, angleDeg: 13 },
  ...
  backAir: {
    ...
    recoveryFrames: 16,
    damage: 7,
    knockback: { base: 292, growth: 8, damageFactor: 8, angleDeg: 18 },
  ...
  upAir: {
    ...
    recoveryFrames: 17,
    damage: 7,
    knockback: { base: 374, growth: 7, damageFactor: 8, angleDeg: 78 },
  ...
  downAir: {
    ...
    recoveryFrames: 18,
    damage: 7,
    knockback: { base: 302, growth: 7, damageFactor: 8, angleDeg: -60 },
  ...
  airNeutralSpecial: {
    ...
    recoveryFrames: 22,
    damage: 10,
    knockback: { base: 366, growth: 8, damageFactor: 8, angleDeg: 16 },
  ...
  airSideSpecial: {
    ...
    recoveryFrames: 24,
    damage: 11,
    knockback: { base: 467, growth: 9, damageFactor: 8, angleDeg: 14 },
  ...
  airUpSpecial: {
    ...
    recoveryFrames: 24,
    damage: 10,
    knockback: { base: 487, growth: 9, damageFactor: 8, angleDeg: 81 },
  ...
  airDownSpecial: {
    ...
    recoveryFrames: 26,
    damage: 11,
    knockback: { base: 422, growth: 8, damageFactor: 8, angleDeg: -64 },
